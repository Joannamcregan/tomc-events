    ...
    <?php if (is_user_logged_in()){
        // if (in_array( 'member', (array) $user->roles ) ){    
            ...
            <div class="page-accent-alt-thin">
                ...
                <input type="datetime-local" id="tomc-event-date-time-picker" name="tomc-event-date-time-picker" aria-labeledby="tomc-event-date-time-picker-label">
                ...
                <div id="tomc-event-presentation-users">
