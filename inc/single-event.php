...
where posts.id = %d
group by posts.id';
$results = $wpdb->get_results($wpdb->prepare($query, $posts_table, $users_table, $usermeta_table, $postmeta_table, $postmeta_table, $postmeta_table, $event_signups_table, $event_tickets_table, $postId), ARRAY_A);
?><main>
